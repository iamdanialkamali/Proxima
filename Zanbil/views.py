...
from .models import Categories,Services,Reserves,Review,Business
...
def showservice(request,service_id):
    ...
    return  render(request, 'ServicePage.html', {'service':service, 'timetable':timetable,'reviews':reviews})
